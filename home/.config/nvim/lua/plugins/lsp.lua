--- @docstring
--- Language Server Protocol configuration and Mason integration.
...
return {
  ...
  config = function()
    ...
    -- CRITICAL: Language Server configuration
    local servers = {
      clangd = {
        cmd = {
          'clangd',
          '--background-index', -- Enables scanning the whole C/C++ project
          '--clang-tidy',
    ...
    ensure_installed = vim.tbl_filter(function(name) return name ~= 'prolog_ls' and name ~= 'hls' end, ensure_installed)
